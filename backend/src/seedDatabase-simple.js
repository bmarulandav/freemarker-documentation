...
// Datos de categorías iniciales (con slugs)
const categories = [
  {
    name: "Básico",
    slug: "basico",
...
const initializeDatabase = async () => {
  try {
    ...
    for (let i = 0; i < examples.length; i++) {
      ...
      example.category = createdCategories[i % createdCategories.length]._id;
      await Example.create(example);
    }
    console.log(`✅ ${examples.length} ejemplos creados`);
